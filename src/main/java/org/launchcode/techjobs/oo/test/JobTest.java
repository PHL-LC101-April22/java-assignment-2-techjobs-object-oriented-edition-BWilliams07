...
public class JobTest {
    ...
    public void testJobConstructorSetsAllFields () {
        ...
        assertTrue(constructorSetsFields.getEmployer() != null);
        assertEquals("ACME", constructorSetsFields.getEmployer().getValue());
        assertTrue(constructorSetsFields.getLocation() != null);
        assertEquals("Desert", constructorSetsFields.getLocation().getValue());
        assertTrue(constructorSetsFields.getPositionType() != null);
        assertEquals("Quality control", constructorSetsFields.getPositionType().getValue());
        assertTrue(constructorSetsFields.getCoreCompetency() != null);
